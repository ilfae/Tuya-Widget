...
async function toggleAlwaysOnTop() {
  try {
    ...
    console.error('Ошибка при переключении режима закрепления окна:', error)
  }
}
...
async function closeWidget() {
  try {
    // Сразу закрываем приложение без подтверждения
...
// Делаем функции управления окном глобально доступными
